...
{
    public class DefaultLoginViewModel : Atomus.MVVM.ViewModel
    {
        #region Declare
        private double loginControlLocationX;
        private double loginControlLocationY;
        ...
        public double LoginControlLocationX
        {
            get
            {
                return this.loginControlLocationX;
            }
            set
            {
                if (this.loginControlLocationX != value)
                {
                    this.loginControlLocationX = value;
                    this.NotifyPropertyChanged();
                }
            }
        }
        public double LoginControlLocationY
        {
            get
            {
                return this.loginControlLocationY;
            }
            set
            {
                if (this.loginControlLocationY != value)
                {
                    this.loginControlLocationY = value;
                    this.NotifyPropertyChanged();
                }
            }
        }
        ...
        public string ButtonBorderColor
        {
            ...
            set
            {
                if (this.buttonBorderColor != value)
                {
